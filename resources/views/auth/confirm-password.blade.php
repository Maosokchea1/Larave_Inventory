                        ...
                        <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <x-text-input id="password" class="block w-full rounded-lg border-slate-300 py-2.5 pl-11 pr-12 text-sm shadow-sm focus:border-blue-600 focus:ring-blue-600" type="password" name="password" required autocomplete="current-password" placeholder="••••••••" />
