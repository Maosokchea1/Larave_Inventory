                ...
                <div class="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-center relative bg-cover bg-center bg-no-repeat" 
                    ...
                    <div class="relative z-10">
                        <div class="mb-6 text-center">
                            <h1 class="text-2xl font-sans tracking-tight text-slate-900">{{ __('Create an account') }}</h1>
                            <p class="mt-2 text-sm text-slate-500">{{ __('Sign up to get started with your account') }}</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-4">
                            ...
                            <!-- Name -->
                            <div>
                                <x-input-label for="name" :value="__('Full Name')" class="mb-1.5 text-sm font-sans text-slate-700" />
                                <div class="relative flex items-center">
                                    ...
                                    <x-text-input id="name" class="block w-full rounded-lg border-slate-300 py-2.5 pl-11 pr-4 text-sm shadow-sm focus:border-blue-600 focus:ring-blue-600" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="{{ __('Your Name') }}" />
                                </div>
                            ...
                            <!-- Email Address -->
                            <div>
                                <x-input-label for="email" :value="__('Email Address')" class="mb-1.5 text-sm font-sans text-slate-700" />
                                <div class="relative flex items-center">
                                    <div class="absolute left-0 flex items-center pl-3.5 pointer-events-none">
                                        <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <x-text-input id="email" class="block w-full rounded-lg border-slate-300 py-2.5 pl-11 pr-4 text-sm shadow-sm focus:border-blue-600 focus:ring-blue-600" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="{{ __('Email Address') }}" />
                                </div>
                            ...
                            <!-- Password -->
                            <div>
                                <x-input-label for="password" :value="__('Password')" class="mb-1.5 text-sm font-sans text-slate-700" />
                                <div class="relative flex items-center">
                                    <div class="absolute left-0 flex items-center pl-3.5 pointer-events-none">
                                        <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <x-text-input id="password" class="block w-full rounded-lg font-sans border-slate-300 py-2.5 pl-11 pr-12 text-sm shadow-sm focus:border-blue-600 focus:ring-blue-600" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
                            ...
                            <!-- Confirm Password -->
                            <div>
                                <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="mb-1.5 text-sm font-sans text-slate-700" />
                                <div class="relative flex items-center">
                                    <div class="absolute left-0 flex items-center pl-3.5 pointer-events-none">
                                        <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                                    ...
                                    <x-text-input id="password_confirmation" class="block w-full rounded-lg font-sans border-slate-300 py-2.5 pl-11 pr-12 text-sm shadow-sm focus:border-blue-600 focus:ring-blue-600" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
                        ...
                        <p class="mt-5 text-center text-sm text-slate-500">
                            ...
                            <a href="{{ route('login') }}" class="font-sans text-blue-700 hover:text-blue-800 underline">{{ __('Sign in') }}</a>
                        </p>
                    </div>
                </div>
